...
type Enterprise struct {
	gorm.Model
	EnterpriseName            string     `gorm:"type:varchar(200);comment:企业名称" json:"enterprise_name"`
	RegistrationStatus        string     `gorm:"type:varchar(32);comment:登记状态" json:"registration_status"`
	LegalRepresentative       string     `gorm:"type:varchar(64);comment:法定代表人" json:"legal_representative"`
	RegisteredCapital         string     `gorm:"type:varchar(255);comment:注册资本" json:"registered_capital"`
	RegDate                   *time.Time `gorm:"comment:成立日期" json:"reg_date"`
	SocialCode                string     `gorm:"type:varchar(32);comment:统一社会信用代码;index" json:"social_code"`
	EnterpriseRegAddr         string     `gorm:"type:varchar(255);comment:企业注册地址" json:"enterprise_reg_addr"`
	Phone                     string     `gorm:"type:varchar(32);comment:电话" json:"phone"`
	...
	TaxNumber                 string     `gorm:"type:varchar(32);comment:纳税人识别号" json:"tax_number"`
	RegNumber                 string     `gorm:"type:varchar(255);comment:注册号" json:"reg_number"`
	OrgCode                   string     `gorm:"type:varchar(64);comment:组织机构代码" json:"org_code"`
